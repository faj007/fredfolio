...
const Projet: React.FC = () => {
  ...
  <div data-aos="zoom-in"data-aos-duration="3000" className="w-full text-center text-white py-6 md:py-10">
      ...
      <div>
        {projects.map((project, idx) => (
          ...
          >
            ...
            <h3 data-aos="zoom-in"data-aos-duration="3000" className="text-3xl sm:text-4xl md:text-6xl text-white mb-4">
              {project.title}
            </h3>

            {project.subtitle && (
              <p data-aos="zoom-in"data-aos-duration="3000" className="text-gold text-sm md:text-base mb-8">
                {project.subtitle}
              </p>
            )}

            <div className="flex justify-center items-center w-full p-5">
              <div data-aos="fade-up"data-aos-duration="3000" className="border shadow-teal-300 shadow-md max-w-xl p-2 rounded-lg">
